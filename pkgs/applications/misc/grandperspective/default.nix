...
let
  appName = "GrandPerspective.app";
  version = "3.0.1";
  versionUnderscore = builtins.concatStringsSep "_" (builtins.splitVersion version);
in stdenv.mkDerivation rec {
  inherit version;
  pname = "grandperspective";

  src = fetchurl {
    url = "mirror://sourceforge/grandperspectiv/GrandPerspective-${versionUnderscore}.dmg";
